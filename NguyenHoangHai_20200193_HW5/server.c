// When sending extracted string to client, the server needs to sleep for 2 seconds.
// This makes sure the letters and digits are not concatenated when sending to client
        ...
        while (true) {
            ...
            if (client_status == SELECT_IN_PROGRESS) {
                ...
                if (strcmp(recv_data, "") == 0) {
                    ...
                    sleep(2); // make sure 2 strings are not concatenated
